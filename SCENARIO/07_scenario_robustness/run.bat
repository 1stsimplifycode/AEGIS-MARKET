...
REM SCENARIO-07  Scenario robustness
REM Canonical implementation: research/scenario/engine.py::ScenarioEngine, research/scenario/transactions.py::fixture
REM
...
call "%AEGIS_ROOT%\tools\aegis_module.bat" SCENARIO-07 %*
exit /b %ERRORLEVEL%
